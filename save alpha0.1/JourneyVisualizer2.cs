        ...
        private bool RefreshPath(Path path)
        {
            ...
            */
            ...
            if (transportInfo != null)
            {
                ...
                path.m_requireSurfaceLine = false; // transportInfo.m_requireSurfaceLine;
                path.m_layer = 2; // transportInfo.m_prefabDataLayer;
                path.m_layer2 = 2; //transportInfo.m_secondaryLayer;
            }
