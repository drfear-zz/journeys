  ...
  public class JourneysPanel : UIPanel
  {
    ...
    public void SetupPanel()
    {
      ...
      _blendChk = blendChk;
			...
			UIPanel blankthrough = uiPanel2.AddUIComponent<UIPanel>();
			blankthrough.size = new Vector2(328, 8);
      ...
      journeysBtn2.text = "reverse cycle";
			...
			UIPanel blankall = uiPanel2.AddUIComponent<UIPanel>();
			blankall.size = new Vector2(328, 8);
      ...
      allBtn.text = "show every known journey (slow!)";
    ...
    private void ExitBtn(UIComponent component, UIMouseEventParameter p)
    {
      if (Redirector<JourneyDetourer>.IsDeployed())
      {
        ...
        Singleton<JourneysButton>.instance._jbutton.Unfocus();
				Singleton<JourneyVisualizer>.instance.DestroyJourneys();
			}
		}
