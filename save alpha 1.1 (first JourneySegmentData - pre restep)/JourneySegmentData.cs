...
// holding lists of the citizens and lines that pass through a segment, with a (quick access) count of citizens for heat mapping
//
// the structure does not link particular citizens to particular lines, that's not really needed, because the citizen's Journeys have line details if wanted
...
namespace Journeys
{
    ...
    {
        //public ushort m_citizenCount;     // count maintained for speed of reference, of course it could instead be obtained by taking the length of the list
        ////private HashSet<ushort> m_citizens;
        ////private Dictionary<ushort, ushort> m_linecounts;
